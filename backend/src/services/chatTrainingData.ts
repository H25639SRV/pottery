export const TRAINING_DATA = [
  {
    keywords: ["tưới", "nước"],
    answer: "Bạn nên tưới cây vào sáng sớm hoặc chiều mát 🌱",
  },
  {
    keywords: ["ánh sáng", "mặt trời"],
    answer: "Hầu hết cây cảnh thích ánh sáng gián tiếp 🌞",
  },
  {
    keywords: ["đất", "giá thể"],
    answer: "Đất tơi xốp, thoát nước tốt là quan trọng nhất 🌿",
  },
  {
    keywords: ["chăm sóc", "cắt tỉa"],
    answer: "Bạn nên cắt lá úa, thay chậu 6 tháng/lần để cây khỏe 🌱",
  },
  {
    keywords: ["chậu", "gốm"],
    answer: "Chậu gốm Mộc Gốm được nung ở nhiệt độ cao, bền và an toàn 🌾",
  },
  {
    keywords: ["địa chỉ"],
    answer:
